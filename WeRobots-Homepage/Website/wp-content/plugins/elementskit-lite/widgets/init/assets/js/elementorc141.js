!function(e, t) {
	...
	let n = {
		...
		Whatsapp: function(t) {
			...
			"show" == e(".elementskit-whatsapp__content").data("show") && e(".elementskit-whatsapp__content").addClass("elementskit-whatsapp__active"),
			e(n).click((function() {
			...
			e(i).keypress((function(t) {
				13 == t.which && (a(),
				window.location = e(".elementskit-whatsapp__input--btn").attr("href"))
			}
			))
		},
